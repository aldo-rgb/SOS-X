    ...
    <View style={styles.container}>
      ...
      {selectedIds.length > 0 && (() => {
        ...
        const totalToPay = selectedPackages.reduce((sum, p) => {
          const pp = p as any;
          // Si el backend envía datos PO Box, recalcular para evitar saldo_pendiente incompleto
          ...
          const saldo = (poboxUsd > 0 && tc > 0)
            ? Math.max(0, (poboxUsd * tc) + gexTotal + shipping - pagado)
