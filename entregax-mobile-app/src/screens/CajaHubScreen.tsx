 ...
 * CajaHubScreen
 * -----------------------------------------------------------
 * Landing del módulo Caja para admin / super_admin / director.
 * Tres tarjetas:
 *   1. Caja CC          → operativa (ingresos/egresos)
 *   2. Caja Sucursales  → tesorería por sucursal
 *   3. Dashboard Cobranza → solo lectura (KPIs)
 */
...
type Props = NativeStackScreenProps<RootStackParamList, 'CajaHub'>;
...
const OPTIONS: Option[] = [
  {
    id: 'cc',
    title: 'Caja CC',
    subtitle: 'Ingresos, egresos y transacciones del centro de costos',
    icon: 'cash-outline',
    color: '#2E7D32',
    route: 'CajaCC',
  },
  {
    id: 'sucursales',
    title: 'Caja Sucursales',
    subtitle: 'Tesorería, billeteras y movimientos por sucursal',
    icon: 'business-outline',
    color: '#1976D2',
    route: 'BranchTreasury',
  },
  {
    id: 'cobranza',
    title: 'Dashboard de Cobranza',
    subtitle: 'KPIs de ingresos, SPEI, efectivo y cartera vencida',
    icon: 'analytics-outline',
    color: '#7B1FA2',
    badge: 'Solo lectura',
    route: 'CobranzaDashboard',
  },
];

export default function CajaHubScreen({ navigation, route }: Props) {
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.headerSubtitle}>Centro de costos · Sucursales · Cobranza</Text>
        </View>
      </View>
      ...
      <ScrollView contentContainerStyle={{ padding: 14, paddingBottom: 40 }}>
        <View style={styles.intro}>
          ...
          <Text style={styles.introTxt}>
            Selecciona un módulo. Caja CC y Sucursales son gestionables; Dashboard de Cobranza es solo informativo en esta etapa.
          </Text>
        </View>
