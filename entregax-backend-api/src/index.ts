...
import { zaiaHealth, zaiaVerify, zaiaTareas, zaiaPersonas, zaiaPreguntar, zaiaRevisarTarea, zaiaCerrarTarea, zaiaApuntarPendiente, zaiaTareaDetalle, zaiaTickets, zaiaTicketDetalle } from './zaiaController';
...
app.get('/api/migrate/orders-summary', async (_req: Request, res: Response) => {
  try {
    ...
    await pool.query(`
      ...
      ALTER TABLE maritime_orders ADD COLUMN IF NOT EXISTS arrival_notified_at TIMESTAMPTZ;
...
app.get('/api/admin/crm/leads/:leadKey/messages', authenticateToken, requireMinLevel(ROLES.COUNTER_STAFF), getLeadMessageHistory);
app.get('/api/admin/crm/template-audience', authenticateToken, requireMinLevel(ROLES.COUNTER_STAFF), getTemplateAudience);
...
app.get('/api/zaia/tickets', zaiaTickets);
app.get('/api/zaia/ticket/:folio', zaiaTicketDetalle);
