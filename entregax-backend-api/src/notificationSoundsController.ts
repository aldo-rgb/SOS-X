...
export const NOTIFICATION_TYPES: Array<{ key: string; label: string; description: string; group: string }> = [
  ...
  { key: 'xpay_por_vencer',    label: '⏳ X-Pay por vencer',            description: 'Una operación X-Pay está por cancelarse y falta subir el comprobante. Le llega al cliente y a su asesor.', group: 'Operación' },
  { key: 'deposit_orphan',     label: '💰 Depósito sin aplicar',       description: 'Entra un depósito con la referencia de una orden ya pagada o cancelada: nadie lo aplicó.', group: 'Interno' },
