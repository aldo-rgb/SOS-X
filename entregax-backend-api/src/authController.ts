...
export const loginUser = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        const isStaff = ['advisor', 'sub_advisor', 'counter_staff', 'warehouse_ops', 'customer_service', 'repartidor', 'accountant', 'abogado', 'operaciones', 'monitoreo', 'soporte_tecnico'].includes(user.role);
