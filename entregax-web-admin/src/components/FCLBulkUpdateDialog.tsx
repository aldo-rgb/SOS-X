...
const FCL_STATUSES: { value: string; label: string; icon: string }[] = [
    ...
    { value: 'docs_received', label: 'Documentos Recibidos', icon: '📄' },
    { value: 'procedure_requested', label: 'Trámite Solicitado', icon: '📝' },
    { value: 'cbp_signature_received', label: 'Firma Electrónica CBP Recibida', icon: '🖊️' },
