...
const STATUS_CONFIG: Record<string, { label: string; color: string; labelEn: string; labelZh: string }> = {
    ...
    'docs_received': { label: 'Documentos Recibidos', labelEn: 'Documents Received', labelZh: '已收到文件', color: '#1E88E5' },
    'procedure_requested': { label: 'Trámite Solicitado', labelEn: 'Procedure Requested', labelZh: '已申请手续', color: '#3949AB' },
    'cbp_signature_received': { label: 'Firma Electrónica CBP Recibida', labelEn: 'CBP e-Signature Received', labelZh: '已收到CBP电子签名', color: '#5E35B1' },
    ...
    'received_mty': { label: 'Recibido en CDMX', labelEn: 'Received in CDMX', labelZh: '已到墨西哥城', color: '#00ACC1' },
