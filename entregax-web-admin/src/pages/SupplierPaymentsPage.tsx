            ...
            <Table>
              <TableHead>
                <TableRow sx={{ bgcolor: HEADER_BG, borderBottom: `1px solid ${BORDER}` }}>
                  ...
                  <TableCell align="right" sx={{ color: TEXT_DIMMER, fontWeight: 700, textTransform: 'uppercase', fontSize: '0.65rem', letterSpacing: '0.1em', borderBottom: `1px solid ${BORDER}` }}>Destino Divisa</TableCell>
