...
const MaritimeConsolidationsPage: React.FC = () => {
  ...
  const MARITIME_STATUS_OPTIONS: Array<{ value: string; label: string; color: 'default' | 'primary' | 'secondary' | 'error' | 'info' | 'success' | 'warning' }> = [
    ...
    { value: 'docs_received',    label: 'Documentos Recibidos', color: 'primary' },
    { value: 'procedure_requested', label: 'Trámite Solicitado', color: 'primary' },
    { value: 'cbp_signature_received', label: 'Firma CBP Recibida', color: 'primary' },
