        ...
        <Box sx={{
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} sx={{ mb: 4 }}>
              ...
              <Box sx={{
                bgcolor: 'rgba(255,255,255,0.05)', color: 'rgba(255,255,255,0.28)',
                borderRadius: 3, px: 3, py: 1.5, display: 'flex', alignItems: 'center', gap: 1.5,
                border: '1px solid rgba(255,255,255,0.07)', cursor: 'not-allowed', minWidth: 180,
              }}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20" style={{ opacity: 0.25 }}>
                ...
                <Box sx={{ textAlign: 'left' }}>
                  <Typography variant="caption" display="block" sx={{ fontSize: 9, lineHeight: 1 }}>Muy pronto en</Typography>
