...
const LT = {
  es: {
    ...
    emailHelper: 'Correo, Número de Cliente (S1234), teléfono verificado o código de asesor (ALDO-6251)',
  ...
  en: {
    ...
    emailHelper: 'Email, Customer Number (S1234), verified phone or advisor code (ALDO-6251)',
  ...
  zh: {
    ...
    emailHelper: '邮箱、客户号 (S1234)、已验证的电话 或 顾问代码 (ALDO-6251)',
    passwordLabel:'密码',
    loginBtn:    '登录面板',
    forgotPw:    '忘记密码？',
    trackBtn:    '🔍 查询包裹',
