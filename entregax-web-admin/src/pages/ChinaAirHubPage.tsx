...
const OPTIONS = [
    ...
    },
    {
        ...
        title: 'Recibir DHL Express',
        description: 'Captura en serie de envíos de la ruta DHL Express China → Monterrey',
        icon: <ShippingIcon sx={{ fontSize: 56, color: '#D40511' }} />,
        bgGradient: 'linear-gradient(135deg, #FFCC00 0%, #FFD740 100%)',
    },
    {
        key: 'tdi_outbound' as const,
        title: 'Enviar DHL Express',
        description: 'Da salida a las cajas DHL Express listas para salir de China',
        icon: <FlightTakeoffIcon sx={{ fontSize: 56, color: '#D40511' }} />,
        bgGradient: 'linear-gradient(135deg, #FFCC00 0%, #FFD740 100%)',
    },
    {
