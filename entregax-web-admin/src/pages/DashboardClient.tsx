                              ...
                              <Box sx={{ display: 'flex', gap: 0.25, justifyContent: 'center' }}>
                                ...
                                <Tooltip title="Descargar PDF" arrow>
                                  <IconButton
                                    ...
                                    const breakdownRows = fmtBrk('🚚 Paquetería (Envío Nacional)', Number(bd.paqueteria)||0) + fmtBrk('🛡️ GEX — Garantía Extendida', Number(bd.gex)||0, '#2E7D32') + fmtBrk('➕ Cargos Extra', Number(bd.extra)||0, '#C2410C');
