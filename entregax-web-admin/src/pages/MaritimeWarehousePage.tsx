...
const STATUS_CONFIG: Record<string, { label: string; color: 'default' | 'warning' | 'info' | 'success' | 'error' | 'primary' }> = {
  ...
  docs_received: { label: '📄 Documentos Recibidos', color: 'info' },
  procedure_requested: { label: '📝 Trámite Solicitado', color: 'info' },
  cbp_signature_received: { label: '🖊️ Firma Electrónica CBP Recibida', color: 'info' },
